...
public abstract class Query implements Cloneable {
	 ...
	 * @return 
	 */
	public Object executeQueryTemplate(String sql, Object[] params, Class<?> clazz, OrmCallBack back){
	...
	public List queryRows(final String sql, final Class<?> clazz, final Object[] params) {
		...
		return  (List) executeQueryTemplate(sql, params, clazz, new OrmCallBack() {
			@Override
...
//		return list;
	...
	public Object queryValue(String sql, Object[] params) {
		...
		return executeQueryTemplate(sql, params, null, new OrmCallBack() {
			@Override
			public Object doExecute(Connection conn, PreparedStatement ps, ResultSet rs) {
				Object value = null;
				try {
